...
public class ChangerMotePasseLycee extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChangerMotePasseLycee frame = new ChangerMotePasseLycee();
	...
	public ChangerMotePasseLycee() {
		...
		btnRetoure.setBounds(49, 414, 150, 29);
