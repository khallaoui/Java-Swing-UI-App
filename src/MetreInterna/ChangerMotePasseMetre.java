...
public class ChangerMotePasseMetre extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChangerMotePasseMetre frame = new ChangerMotePasseMetre();
	...
	public ChangerMotePasseMetre() {
		...
		btnNewButton_1.setBounds(63, 414, 130, 27);
